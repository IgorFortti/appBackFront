...
class QuotationEthTableViewCellScreen: UIView {
    ...
    private func configConstraints() {
        NSLayoutConstraint.activate([
            ...
            coinEthImageView.centerYAnchor.constraint(equalTo: backgroundView.centerYAnchor),
            coinEthImageView.trailingAnchor.constraint(equalTo: backgroundView.trailingAnchor, constant: -4),
            coinEthImageView.widthAnchor.constraint(equalToConstant: 180),
            coinEthImageView.heightAnchor.constraint(equalToConstant: 180),
        ])
    }
}
